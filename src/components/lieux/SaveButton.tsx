  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        onClick={onClick}
        disabled={saving}
        className="w-full rounded-md bg-[#22435D] px-5 py-3 text-base font-bold text-white transition-colors hover:bg-[#1a3349] focus:outline-none focus:ring-2 focus:ring-[#22435D] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
      >
        {saving ? (
